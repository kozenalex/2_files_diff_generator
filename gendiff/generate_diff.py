...
from gendiff.load_data import parse, get_format, read_file


def generate_diff(source1, source2, format='stylish'):
    data1 = parse(read_file(source1), get_format(source1))
    data2 = parse(read_file(source2), get_format(source2))
